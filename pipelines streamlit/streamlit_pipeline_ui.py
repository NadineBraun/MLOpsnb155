...
BASE_DIR = "/Users/nadinebraun/Documents/Master/Semester 4/PM1 ML Ops/ML-Ops-nb155"
...
with tabs[0]:
    ...
    years = st.multiselect("Wähle Jahre für das Beispiel-Mapping:", options=list(range(2009, 2025)), default=[2009])
    sample_file = None
    for year in years:
        test_path = os.path.join(BASE_DIR, f"yellow_tripdata_{year}-01.parquet")
    ...
    if sample_file:
        ...
        if st.button("Speichere Mapping-Datei"):
            ...
            mapping_path = os.path.join(BASE_DIR, "mapping_overrides.json")
...
with tabs[7]:
    ...
    years_1 = st.multiselect("Zeitraum 1: Wähle Jahre", years, default=[2009, 2010, 2011, 2012, 2013, 2014], key="zeitraum1")
    years_2 = st.multiselect("Zeitraum 2: Wähle Jahre", years, default=[2015, 2016, 2017], key="zeitraum2")
